 ...
 */
export default function KakaoIcon({ ...props }: BaseIconProps): React.JSX.Element {
	return (
		<svg name="KakaoIcon" viewBox="0 0 99.61801 92.147011" xmlns="http://www.w3.org/2000/svg" {...props}>
			<g id="g686" transform="matrix(1,0,0,-1,-362.26358,234.09895)">
				<g clipPath="url(#clipPath692)" id="g688">
					<g id="g694" transform="translate(163.2612,376.6777)">
						<path
